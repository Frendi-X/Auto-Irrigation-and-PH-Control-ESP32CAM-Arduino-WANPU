...
String BOTtoken = "8338560090:AAFf2iykD6ID4XtykPLC7N3cOeZShMiiHRY";  // your Bot Token (Get from Botfather)

// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String CHAT_ID = "6861976939";
...
void loop() {
  ...
  while (Serial2.available() > 0)
  {
    ...
    else if (StringData.length() > 0 && CharData == '@')
    {
      ...
      texttt += status_PH;
      texttt += nilai_PH + "\n\n";
      texttt += "Terong belum siap dipanen";
